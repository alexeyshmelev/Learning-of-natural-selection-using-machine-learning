...
def INT():
    ...
    class KINT(tf.keras.Model):
        def __init__(self):
            ...
            self.initial1 = tf.keras.layers.Conv1D(256, 20, padding='same')
            self.initial2 = tf.keras.layers.Conv1D(256, 20, padding='same')
            ...
            self.initial3 = tf.keras.layers.Conv1D(256, 20, padding='same')
            self.initial4 = tf.keras.layers.Conv1D(256, 20, padding='same')
            ...
            self.initial5 = tf.keras.layers.Conv1D(256, 20, padding='same')
            self.initial6 = tf.keras.layers.Conv1D(256, 20, padding='same')
            ...
            self.initial7 = tf.keras.layers.Conv1D(256, 20, padding='same')
            self.initial8 = tf.keras.layers.Conv1D(256, 20, padding='same')
